...
@endif
    {{
        $attributes
            ->class([
                'inline-block font-medium rounded-xl tracking-tight transition-colors',
                'bg-gray-200 hover:bg-gray-100' => ! $attributes->hasAny('disabled', 'primary'),
                'bg-blue-600 hover:bg-blue-500 text-white' => $attributes->has('primary'),
                'bg-gray-100 hover:bg-blue-100 text-gray-300!' => $attributes->has('disabled'),
