<div>
    ...
    <input
        type="{{ $type ?? 'text' }}"
        id="{{ $id }}"
        {{ $attributes->except(['id', 'type'])->class('w-full block px-3 py-2 placeholder-gray-300 rounded-md shadow shadow-black/5 border border-gray-200 disabled:opacity-30') }}
    />
