...
<a href="{{ $book['link'] }}" target="_blank" {{ $attributes->class('text-sm/tight md:text-base/tight') }}>
    ...
    <div class="inline-block md:text-sm md:rounded-md px-[.65rem] py-[.35rem] text-xs rounded-sm mt-3 font-medium text-white transition-colors bg-blue-600 hover:bg-blue-500 md:mt-4">
        Check the book
    </div>
</a>
