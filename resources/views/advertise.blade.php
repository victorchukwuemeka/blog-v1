...
>
    ...
    <div class="mt-24 text-center">
        ...
        <div class="flex flex-wrap gap-y-4 gap-x-8 justify-center items-center px-4 mt-5 md:gap-x-12 lg:gap-x-16">
            ...
            {{-- Meilisearch --}}
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 162 25" class="flex-none h-6 sm:h-7">
            ...
            {{-- Sevalla --}}
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 1700 560" class="flex-none h-9 sm:h-10">
